...
- (void)viewDidLoad
{
    ...
    //添加右边刷新按钮
    UIImage *backItemImage = [UIImage imageNamed:@"white_refresh"];
    UIButton *refreshButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [refreshButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [refreshButton setImage:backItemImage forState:UIControlStateNormal];
    [refreshButton sizeToFit];
    [refreshButton addTarget:self action:@selector(roadLoadClicked) forControlEvents:UIControlEventTouchUpInside];
    UIBarButtonItem *roadLoad = [[UIBarButtonItem alloc] initWithCustomView:refreshButton];
...
- (UIBarButtonItem *)customBackBarItem
{
    if (!_customBackBarItem) {
        UIImage *backItemImage = [UIImage imageNamed:@"icon-back"];
...
- (UIProgressView *)progressView
{
    if (!_progressView) {
        ...
        _progressView.progressTintColor = [UIColor colorWithRed:252.0 / 255 green:88.0 / 255 blue:112.0 / 255 alpha:1.0];
    }
...
- (UIBarButtonItem *)closeButtonItem
{
    if (!_closeButtonItem) {
        ...
        [cancelButton addTarget:self action:@selector(closeItemClicked) forControlEvents:UIControlEventTouchUpInside];
        _closeButtonItem = [[UIBarButtonItem alloc] initWithCustomView:cancelButton];
    }
