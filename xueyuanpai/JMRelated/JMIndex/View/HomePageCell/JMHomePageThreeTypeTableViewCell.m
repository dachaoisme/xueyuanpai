...
- (void)initContentCell{
    ...
    if (_subtitleLabel == nil) {
        _subtitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMinX(_titleLabel.frame), CGRectGetMaxY(_titleLabel.frame) + 8, CGRectGetWidth(_titleLabel.frame), 14)];
