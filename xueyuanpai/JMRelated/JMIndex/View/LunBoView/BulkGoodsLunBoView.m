...
@implementation BulkGoodsLunBoView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _pageControl.frame = CGRectMake(0, frame.size.height - 20, SCREEN_WIDTH, 20);
        _pageControl.currentPageIndicatorTintColor = [CommonUtils colorWithHex:@"00c05c"];
        _pageControl.pageIndicatorTintColor = [UIColor colorWithRed:200/255.0 green:200/255.0 blue:200/255.0 alpha:0.5];
...
- (void)configContentViews
{
    ...
    for (int i = 0; i<self.contentViews.count; i++) {
        NSURL *url = [self.contentViews objectAtIndex:i ];
