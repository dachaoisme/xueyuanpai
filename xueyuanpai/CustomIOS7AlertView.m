...
- (id)init
{
    ...
    if (self)
    {
        ...
        _saveClickButtonArray = [[NSMutableArray alloc] init];
    }
    return self;
}
...
//    dialogContainer.layer.borderWidth = 1;
    ...
    lineView.backgroundColor = [UIColor colorWithRed:223.0/255.0 green:223.0/255.0 blue:223.0/255.0 alpha:1.0f];
...
//        [closeButton setBackgroundImage:[UIImage imageNamed:@"button.png"] forState:UIControlStateNormal];
        closeButton.backgroundColor = [CommonUtils colorWithHex:@"f2f2f2"];
        [closeButton setTitle:[buttonTitles objectAtIndex:i] forState:UIControlStateNormal];
        [closeButton setTitleColor:[CommonUtils colorWithHex:@"727171"] forState:UIControlStateNormal];//[UIColor colorWithRed:225 green:0 blue:0 alpha:0.7] forState:UIControlStateNormal]
        [closeButton.titleLabel setFont:[UIFont boldSystemFontOfSize:18.0f]];
        [_saveClickButtonArray addObject:closeButton];
        if (i == 2) {
            [closeButton setFrame:CGRectMake(i*buttonWidth, container.bounds.size.height - buttonHeight, buttonWidth+30, buttonHeight)];
            closeButton.titleLabel.textAlignment = NSTextAlignmentCenter;
            [container addSubview:closeButton];
            
            UIButton *shareBtn= [[UIButton alloc] initWithFrame:CGRectMake(10, 14, 25, 22)];
            [shareBtn addTarget:self action:@selector(customIOS7dialogButtonTouchUpInside:) forControlEvents:UIControlEventTouchUpInside];
            [shareBtn setBackgroundImage:[UIImage imageNamed:@"bg_ticket_pup_share.png"] forState:UIControlStateNormal];;
            [closeButton addSubview:shareBtn];
        }
...
//            [container addSubview:lineView];
        ...
        UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(buttonWidth*i, container.bounds.size.height - buttonHeight, 1, buttonHeight)];
        lineView.backgroundColor = [CommonUtils colorWithHex:@"d7d7d7"];
