...
@end
@implementation BannerLunBoView
...
- (void)configContentViews
{
    ...
    for (int i = 0; i<self.contentViews.count; i++) {
        ...
        [contentView setImageWithURL:url placeholderImage:[UIImage imageNamed:@"theBannerPlaceImage"]];
...
//    for (LKHotBannerForProgram * item in self.contentViews) {
//
//        
//        
//        contentView.userInteractionEnabled = YES;
