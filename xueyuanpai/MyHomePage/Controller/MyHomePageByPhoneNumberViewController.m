//
//  MyHomePageByPhoneNumberViewController.m
//  xueyuanpai
//
...
@interface MyHomePageByPhoneNumberViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MyHomePageByPhoneNumberViewController
...
- (void)requestMineInformation{
    ...
    [dic setValue:self.telePhoneNumber forKey:@"mobile"];
