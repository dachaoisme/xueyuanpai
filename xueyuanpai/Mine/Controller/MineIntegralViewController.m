...
- (void)createTableViewHeaderView{
    ...
    //创建右侧视图的两个label
    UILabel *jifenLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetWidth(rightView.frame) / 2 - 30, 33, 60, 14)];
    jifenLabel.font = [UIFont systemFontOfSize:14];
    jifenLabel.textColor = [CommonUtils colorWithHex:@"f8f8f8"];
    jifenLabel.text = @"我的钱包";
    [rightView addSubview:jifenLabel];
    
    
    //兑换积分
    UILabel *integralLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMinX(jifenLabel.frame), CGRectGetMaxY(jifenLabel.frame)+10, CGRectGetWidth(jifenLabel.frame), 42)];
