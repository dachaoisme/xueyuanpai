//
//  RequirementsSuccessViewController.m
//  xueyuanpai
//
//  Created by 王园园 on 16/6/20.
...
@implementation RequirementsSuccessViewController
...
- (void)createView{
    ...
    alertTwoLabel.text = @"请随时关注消息，及时回复申请";
    ...
    [backButton setTitle:@"返回时间银行" forState:UIControlStateNormal];
...
//    [CommonUtils showToastWithStr:@"分享"];
    ...
    if (imageArray) {
        ...
        [shareParams SSDKSetupShareParamsByText:@"发布成功"
                                         images:imageArray
