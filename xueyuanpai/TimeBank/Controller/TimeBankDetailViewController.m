...
- (void)didClickSharButtonItemAction:(UIBarButtonItem *)buttonItem
{
    ...
    [imageView sd_setImageWithURL:[NSURL URLWithString:detailModel.timeBankDetailIcon] placeholderImage:[UIImage imageNamed:@"share.png"]];
    ...
    if (imageArray) {
        ...
        [shareParams SSDKSetupShareParamsByText:detailModel.timeBankDetailContent
                                         images:imageArray
