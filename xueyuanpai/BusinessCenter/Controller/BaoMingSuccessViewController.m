...
- (void)createView{
    ...
    [backButton setTitle:@"返回讲堂详情" forState:UIControlStateNormal];
    ...
    if (_points.length == 0) {
        ...
        alertLabel.text = [NSString stringWithFormat:@"创业讲堂报名成功  恭喜你获得%@积分",_points];
    }
}
...
//    [CommonUtils showToastWithStr:@"分享"];
    ...
    if (imageArray) {
        ...
        [shareParams SSDKSetupShareParamsByText:@"创业讲堂报名成功"
                                         images:imageArray
